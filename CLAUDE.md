...
`icff.md`, `plateread.md`, `dcal.md`, and `pltd.md` are marked **fully decoded** and validated
against the committed samples in `samples/`. `pcrd.md`'s container and plate-read data are
